      ...
      <div className="container-custom">
        ...
        >
          ...
          >
            ...
            >
              <div className="w-20 h-20 mx-auto bg-gradient-to-br from-gradient-start to-gradient-end rounded-2xl flex items-center justify-center shadow-glow-lg">
                <Code className="w-10 h-10 text-white" />
              </div>
            </motion.div>
            
            <GradientText as="h2" className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
              Skills & Expertise
            </GradientText>
            
            <p className="text-text-secondary text-xl max-w-4xl mx-auto leading-relaxed">
            ...
            >
              {[
                ...
                <motion.div
                  key={index}
                  variants={skillCardVariants}
                  className="flex items-center space-x-3 bg-background-secondary/50 backdrop-blur-sm px-4 py-3 rounded-xl border border-border hover:border-gradient-start transition-all duration-300"
                  whileHover={{ scale: 1.05, y: -2 }}
                >
                  <stat.icon className="w-5 h-5 text-gradient-start" />
                  <div className="text-left">
                    <div className="text-2xl font-bold text-gradient-start">{stat.value}</div>
          ...
          >
            {/* View Mode Toggle */}
            <div className="flex items-center space-x-2 bg-background-secondary/50 backdrop-blur-sm p-1 rounded-xl border border-border">
              {[
                ...
                return (
                  ...
                  >
                    ...
                    <Badge 
                      ...
                      size="sm"
                      className={`ml-1 ${isActive ? 'bg-white/20' : ''}`}
                    >
                      {category.count}
                    </Badge>
                  </motion.button>
